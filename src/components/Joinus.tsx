                   ...
                   <section className="my-20">
                        ...
                        <Image
                            ...
                            <div className="flex justify-between max-w-[280px] mx-auto mt-6">
                                <p className="text-[#BCBCBC] text-[12px] flex gap-1 items-center"><input type="checkbox" />Sign up for emails to get updates from Nike on products, offers and your Member benefits</p>
                            </div>
